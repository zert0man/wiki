...
## Цели работы
- познакомиться с сервером nginx;
...
1. Сложите полученный результат в папку `/home/q/hws/0` (это место будет изменено), зайдите в браузере на страницу `0.mesdt` и убедитесь, что всё работает. **Обратите внимание! Вы создаете шаблон, заготовку сайта! Загружать туда данные из базы не надо, это просто статические страницы.**	
...
- настроить другое доменное имя для сайта (каталог расположения менять нельзя);
- использовать галереи в страницах описания объектов.
