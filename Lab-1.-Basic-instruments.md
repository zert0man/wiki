...
1. Создать базу данных на сервере MySQL. База данных должна поддерживать ссылочную целостность и русские символы. При создании базы используйте кодировку utf8.
