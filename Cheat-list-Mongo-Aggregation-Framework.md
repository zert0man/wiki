...
Для составления сложных запросов в MongoDB имеется встроенный Aggregation Framework. Запрос выполняется методом `db.collectionname.agregate()`. Действия, выполняемые в запросе, описываются с помощью операторов агрегации. 
